...
public class DayView extends View implements View.OnCreateContextMenuListener,
    ...
    private void init(Context context) {
        ...
        if (theme.equals("dark")) {
            ...
            mFutureBgColorRes = Color.TRANSPARENT;//mResources.getColor(R.color.calendar_future_bg_color_dark);
            ...
            mFutureBgColorRes =Color.TRANSPARENT;// mResources.getColor(R.color.calendar_future_bg_color);
