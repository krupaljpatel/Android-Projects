...
public class MonthByWeekFragment extends SimpleDayPickerFragment implements
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (!mIsMiniMonth) {
            mListView.setBackgroundColor(Color.TRANSPARENT);//(theme.equals("dark") ?(getResources().getColor(R.color.month_bgcolor_dark)) : (getResources().getColor(R.color.month_bgcolor)));
        }
