...
public class MonthWeekEventsView extends SimpleWeekView {
    ...
    private static int EVENT_TEXT_COLOR = Color.TRANSPARENT;
    ...
    protected void loadColors(Context context) {
        ...
        if (theme.equals("dark")) {
            ...
            mMonthBGTodayColor = Color.GREEN;// res.getColor(R.color.month_today_bgcolor_dark);
            ...
            mMonthBGTodayColor = Color.GREEN;////res.getColor(R.color.month_today_bgcolor);
            mMonthBGFocusMonthColor = Color.TRANSPARENT;//res.getColor(R.color.month_focus_month_bgcolor);
            mMonthBGOtherColor = Color.TRANSPARENT;//Color.TRANSPARENT;//res.getColor(R.color.month_other_bgcolor);
            ...
            mTodayAnimateColor =Color.TRANSPARENT;//res.getColor(R.color.today_highlight_color);
